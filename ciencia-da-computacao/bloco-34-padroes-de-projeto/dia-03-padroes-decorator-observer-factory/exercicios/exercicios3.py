# Exercício 3: Você foi convidado a ajudar com uma atualização de segurança
# em um sistema interno de uma empresa. O sistema atende os setores de vendas,
# financeiro e suporte. Para respeitar a nova Lei Geral de Proteção de dados,
# a empresa precisa garantir que as informações internas sejam expostas
#  somente a quem tem necessidade. Assim seremos os seguintes perfis de acesso:
